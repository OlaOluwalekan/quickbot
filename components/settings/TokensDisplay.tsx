  ...
  return (
    <div>
      <div className='flex flex-col justify-center items-center gap-2'>
        ...
        <p className='text-center text-xs text-secondary-content dark:text-dark-secondary-content max-w-[400px]'>
        ...
        <BasicButton
          ...
          title={
            user.token > 0
              ? `You have ${user.token} tokens. You can only request token after you are out of token`
              : ''
          }
        />
      </div>
